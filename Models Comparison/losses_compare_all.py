...
fig.suptitle('Loss Comparison (Uterine Myoma dataset)', fontsize=18)

# Adjust layout to ensure there's no overlap
plt.tight_layout(rect=[0, 0, 1, 0.95])  # Leave space for the suptitle
#plt.show()
# Save the combined plot
plt.savefig(f"{save_path}2025_all_model_losses_baseline_total_MYOMA.png", dpi=600)
...
plt.savefig(f"{save_path}2025_all_model_losses_logarithmic_baseline_total_MYOMA.png", dpi=600)
#plt.show()
